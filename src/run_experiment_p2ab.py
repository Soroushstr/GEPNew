"""
run_experiment_p2ab.py  —  Phase 2a+2b: k=4 + bidirectional edges
Changes on top of Phase 1:
  2a: k increased from 3 to 4 (256 possible node types vs 64),
      giving richer per-node identity and more discriminative graphs.
  2b: bidirectional=True passed to build_dataset so both strands of
      the double-stranded DNA contribute to the k-mer transition graph.
"""
...
from seq_encoder_p2ab import build_dataset
...
CONFIG = {
    ...
    "k":               4,           # Phase 2a: increased from 3 → 4
    "bidirectional":   True,        # Phase 2b: model both DNA strands
...
def main():
    ...
    print("  Using saved optimal threshold from training checkpoint.")
